                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                          ...
                          $i=0;
                             $sql = "SELECT * FROM  c_member ORDER BY id DESC";
                        ...
                        $i++;
                            ?>
                                                          ...
                                                          <td>
                                                            <a href="detail.php?car_id=<?=$result['id'];?>">
															<?=$result['firstname']; ?>
                                                            </a>
                                                          </td>
                                                          <td><?=$result['id'];?></td>
                                                          <td><?=$result['email'];?></td>
                                                          <td><?=$result['phone'];?></td>
                                                          <td><img src="../cardoor/pic/<?=$result['img']; ?>" width="130px" height="100px"></td>
                                                          <td>
                                                            <a href="editcus.php?id=<?=$result['id']; ?>">
															Edit
                                                            </a>
                                                          </td>
                                                          <td>
                                                            <a href="deletecus.php?id=<?=$result['id']; ?>">
															Delete
                                                            </a>
                                                          </td>
                                                        </tr>
