          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav flex-column">
                ...
                <li class="nav-item ">
                  <a href="location.html" class="nav-link active collapsed" aria-controls="submenu-1"><i class="fa fa-fw fa-rocket"></i>Location <span class="badge badge-success">6</span></a>
      ...
      <div class="container-fluid dashboard-content ">
        ...
        <div class="row">
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
              <h2 class="pageheader-title" >Location </h2>
        ...
        <div class="row">
          <div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="row">
              ...
              <?php 
				     ...
				     if(isset($_GET['edit'])){
			         $sql_edit = "SELECT * FROM c_location where id_lo=$_GET[edit]";
                   	 $query_edit = $conn->query($sql_edit); 
                     $result_edit = $query_edit->fetch_assoc();
					 }
					 
					 if(isset($_GET['del'])){
			         $sql_del = "DELETE FROM c_location WHERE c_location.id_lo = $_GET[del]";
			   ...
			   //echo  "alert('สำเร็จ');";
			    ...
			    echo "</script>";
					 ...
					 if(isset($_POST['add'])){
				 include"config.inc.php";
         $sql = "INSERT INTO c_location (id_lo, name_lo) VALUES (',$_POST[id_lo]', '$_POST[name_lo]')";
         $query = mysqli_query($conn,$sql);
				...
				if(isset($_POST['edit'])){
				include"config.inc.php";
				$sql = "UPDATE c_location SET name_lo = '$_POST[name_lo]' WHERE c_location.id_lo = $_POST[id_lo]";
                $query = mysqli_query($conn,$sql);
			  ...
			  ?>
                           <div class="box box-primary">
                                ...
                                <input name="id_lo" type="hidden" value="<?=@$result_edit['id_lo'];?>">
                                    <div class="box-body">
                                       <div class="row">
                                       <div class="col-xs-6">
             <input type="text" name="name_lo" class="form-control"  value="<?=@$result_edit['name_lo'];?>" placeholder="name" required>
                                        </div>
                                        <div class="col-xs-3">
                     ...
                     <div class="box">
					  ...
					  include"config.inc.php";
					  $i=0;
			         $sql = "SELECT * FROM c_location ORDER BY id_lo DESC";
			        ...
			        ?>
                                            <tr>
                                                <td><?=$i;?></td>
                                                <td><?=$result['name_lo'];?></td>
 <td>
 <a href= "?del=<?=$result['id_lo'];?>" class="btn btn-danger btn-sm"  onClick="return confirm('กรุณายืนยันการลบอีกครั้ง !!!')"> ลบ </a>
 <a href="?edit=<?=$result['id_lo'];?>" class="btn btn-info btn-sm" > แก้ไข </a>
